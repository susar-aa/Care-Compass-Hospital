...
<nav style="padding-top: 5px; padding-bottom: 5px;">
    <!-- Logo as Home Button -->
    <a href="../User/home.php" style="padding-top: 0px;padding-bottom: 0px;">
        <img src="../Assets/navbar_logo.png" alt="Hospital Logo" class="logo-n">
    </a>
    ...
    <div class="dropdown">
        <a href="../User/about.php"><i class="fas fa-info-circle"></i> About Us</a>
        <div class="dropdown-content">
            <a href="../User/contact.php"><i class="fas fa-phone"></i> Contact Us</a>
            <a href="../User/location.php"><i class="fas fa-map-marker-alt"></i> Location</a>
            <a href="../User/about.php"><i class="fas fa-info-circle"></i> About Us</a>
            <a href="../User/feedback.php"><i class="fas fa-comment-dots"></i> Feedbacks</a>
        </div>
    </div>

    <a href="../User/doctor.php"><i class="fas fa-user-md"></i> Doctors</a>
    <a href="../User/view_profile.php"><i class="fas fa-user-circle"></i> Profile</a>
