...
<body>
    ...
    <div class="content">
        ...
        <p>Welcome to your personalized dashboard. We're here to provide the best healthcare services.</p>
        <p>Explore our services and book your appointments with our specialists.</p>
    </div>
...
<section id="quality-data">
    <h2 style="text-align: center;">Quality Data</h2>
...
<section id="about-us" style="padding: 50px; background-color: #f9f9f9;">
    <div style="display: flex; align-items: center; gap: 20px; max-width: 1200px; margin: 0 auto;">
        ...
        <div style="flex: 1; text-align: center;">
            <img src="../Assets/about.png" alt="Hospital Facility" style="max-width: 100%; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        </div>
    </div>
</section>
...
<section id="branches" style="padding: 50px; padding-bottom: 70px; background-color: #f9f9f9; text-align: center; opacity: 0; transform: translateY(50px); transition: opacity 1s ease-out, transform 1s ease-out; ">
    <!-- Branch Info -->
    ...
    <div style="margin-top: 30px; display: flex; justify-content: space-between; align-items: center; gap: 20px; max-width: 800px; margin: 0 auto;">
        ...
        <div class="logo" style="opacity: 0; transform: translateY(20px); transition: opacity 1s ease-out, transform 1s ease-out;">
            <img src="../Assets/kuru_logo.png" alt="Kurunegala Branch Logo" style="width: 150px; height: auto; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <p style="margin-top: 10px; font-size: 14px; font-weight: 500; color: #555;">Kurunegala Branch</p>
        </div>
        <!-- Logo 2 -->
        <div class="logo" style="opacity: 0; transform: translateY(20px); transition: opacity 1s ease-out, transform 1s ease-out;">
            <img src="../Assets/cmb_logo.png" alt="Colombo Branch Logo" style="width: 150px; height: auto; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <p style="margin-top: 10px; font-size: 14px; font-weight: 500; color: #555;">Colombo Branch</p>
        </div>
        <!-- Logo 3 -->
        <div class="logo" style="opacity: 0; transform: translateY(20px); transition: opacity 1s ease-out, transform 1s ease-out;">
            <img src="../Assets/kandy_logo.png" alt="Kandy Branch Logo" style="width: 150px; height: auto; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
